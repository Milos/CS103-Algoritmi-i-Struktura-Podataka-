...
public abstract class AbstractGraph<V> implements Graph<V> {
    ...
    private void dfs(int v, int[] parent, List<Integer> searchOrder,
        ...
        searchOrder.add(v);
        isVisited[v] = true; // Vertex v visited visited:0,1,3
    ...
    /**
     * Modified dfs for finding a cycle
     *
    ...
    public boolean isCyclic() {
        ...
        // Mark visited vertices
        boolean[] isVisited = new boolean[vertices.size()];
//        System.out.println("allVertices" + allVertices);
...
//        }
//        return false;
        return isCyclic(allVertices.get(0), parent, allVertices, isVisited);
    }
...
//            System.out.println("neighbors[u] " + neighbors.get(u));
//            System.out.println("U; " + u);
//            System.out.println("I; " + i);
            if (!isVisited[i]) {
                parent[i] = u; // The parent of vertex i is u                
                isCyclic(i, parent, allVertices, isVisited); // Recursive search
            }
             else if (parent[u] != i) {                                
                return true;
            }
